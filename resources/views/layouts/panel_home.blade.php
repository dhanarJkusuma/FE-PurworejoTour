...
<html lang="en" class="no-js">
  <head>
    ...
    <!-- SWITCHER-->
    <link href="{{URL::asset('assets/plugins/switcher/css/switcher.css')}}" rel="stylesheet" id="switcher-css" media="all"/>
    <link href="{{URL::asset('assets/plugins/switcher/css/color1.css')}}" rel="alternate stylesheet" title="color1" media="all"/>
    <link href="{{URL::asset('assets/plugins/switcher/css/color2.css')}}" rel="alternate stylesheet" title="color2" media="all"/>
    <link href="{{URL::asset('assets/plugins/switcher/css/color3.css')}}" rel="alternate stylesheet" title="color3" media="all"/>
