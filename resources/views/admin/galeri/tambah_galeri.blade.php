	...
	<div class="col-md-12 col-xs-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Kelola Galeri {{ $wisata->judul_konten }}</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        <form role="form" enctype="multipart/form-data" method="POST" action="{{ url('wisata/galeri/') }}/{{ $wisata->id }}/tambah">
          <div class="box-body">
          	{{ csrf_field() }}
